    ...
    <div class="login-container">
        <div class="login-card">
            <div class="logo-section">
                ...
                <p class="text-muted mt-1">Buat akun untuk menyimpan Watchlist</p>
            </div>
            ...
            <p class="text-center text-muted" style="font-size: 0.875rem;">Sudah punya akun? <a href="{{ route('login') }}" class="text-primary text-decoration-none">Masuk di sini</a></p>
