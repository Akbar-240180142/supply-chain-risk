                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.ports.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="code" class="form-control" value="{{ old('code') }}" placeholder="e.g., JKT, SIN" required>
                        </div>
                        ...
                        <button type="submit" class="btn btn-success">
                            <i class="bi bi-check-circle"></i> Save Port
                        </button>
